...
class PageSelectingPrintSource(QWidget):
    ...
    def slot_loadFiles(self, path:str):
        ...
        self.label_counter_page.setText(f" {self.page_id + 1}/{len(self.kuchaFilov)} ")
    ...
    def initUI(self):
        ...
        self.button_prev_dir.setIcon(QIcon(self.arrowpix))
        self.button_prev_dir.setIconSize(QSize(60, 60))

        self.h_nav_layout = QHBoxLayout()
        self.h_nav_layout.addWidget(self.label_full_path, 15)
        self.h_nav_layout.addWidget(self.button_prev_dir, 1)



        self.label_counter_page = QLabel()
        self.label_counter_page.setFont(self.font_label)

        self.button_prev = QPushButton()
        self.button_prev.setIcon(QIcon(self.left_arrow_pixmap))
        self.button_prev.setIconSize(QSize(60,60))
        self.button_prev.clicked.connect(self.prevPage)

        self.button_next = QPushButton()
        self.button_next.setIcon(QIcon(self.right_arrow_pixmap))
        self.button_next.setIconSize(QSize(60,60))
        self.button_next.clicked.connect(self.nextPage)

        self.button_cancel = QPushButton("Выход ")
        self.button_cancel.setFont(self.font_label)
        self.button_cancel.setIcon(QIcon(self.exit_pixmap))
        self.button_cancel.setIconSize(QSize(60,60))
        ...
        self.h_layout.addWidget(self.label_counter_page)
